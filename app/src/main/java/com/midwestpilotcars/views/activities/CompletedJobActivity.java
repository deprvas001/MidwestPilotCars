...
public class CompletedJobActivity extends BaseActivity {
    ...
    public void initializeView(StatusCompleteJob completeJob) {
        try {
            ...
            driver_title.setText("Escort Driver Name");
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Pilot Car Position");
            driver_name = (TextView) view.findViewById(R.id.value);
            if (completeJob.getData().getLoad_type_name() != null)
                driver_name.setText(completeJob.getData().getLoad_type_name());
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("End Point");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Total Gas Expense (Cash)");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Total Motel Expense (Cash)");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Total Other Expense (Cash)");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Total Billing for Days");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Total No Go Price");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Total Down Time Hours");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Total Down Time Price");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Total Credit Card (Deductions)");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Per Mile Cost");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Client Representative Name");
            driver_name = (TextView) view.findViewById(R.id.value);
            ...
            view = (View) findViewById(R.id.job_give_cash);
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Give back in this Job");
            driver_name = (TextView) view.findViewById(R.id.value);
            if (completeJob.getData().getGive_back_cash() != null)
                driver_name.setText("$"+completeJob.getData().getGive_back_cash());


            view = (View) findViewById(R.id.job_payment_method);
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Payment Method");
            driver_name = (TextView) view.findViewById(R.id.value);
            if (completeJob.getData().getPayment_method() != null)
                driver_name.setText(completeJob.getData().getPayment_method());

            view = (View) findViewById(R.id.job_cheque_number);
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Cheque Number");
            driver_name = (TextView) view.findViewById(R.id.value);
            if (completeJob.getData().getCheque_number() != null)
                driver_name.setText(completeJob.getData().getCheque_number());

            view = (View) findViewById(R.id.job_payment_date);
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Payment Date");
            driver_name = (TextView) view.findViewById(R.id.value);
            if (completeJob.getData().getPayment_date() != null)
                driver_name.setText(completeJob.getData().getPayment_date());

            view = (View) findViewById(R.id.job_final_pay_driver);
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Final Pay To Driver");
            driver_name = (TextView) view.findViewById(R.id.value);
            float total_pay_driver=0,give_cash_back=0;
            if(completeJob.getData().getTotal_pay_to_driver()!=null)
            total_pay_driver = Float.parseFloat(completeJob.getData().getTotal_pay_to_driver());

            if(completeJob.getData().getGive_back_cash()!=null){
                give_cash_back = Float.parseFloat(completeJob.getData().getGive_back_cash());
            }

            float final_pay_driver = total_pay_driver - give_cash_back;
                driver_name.setText("$"+String.valueOf(final_pay_driver));


            view = (View) findViewById(R.id.job_remaining_cash_advance);
            driver_title = (TextView) view.findViewById(R.id.title);
            driver_title.setText("Remaining Cash In Advance");
            driver_name = (TextView) view.findViewById(R.id.value);
            float cash_advance=0;

            if(completeJob.getData().getCash_in_advance()!=null){
                cash_advance = Float.parseFloat(completeJob.getData().getCash_in_advance());
            }

            float remaining_cash_advance =cash_advance - give_cash_back;
            driver_name.setText(String.valueOf(remaining_cash_advance));
